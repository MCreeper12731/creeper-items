...
public class ItemBuilder {
    ...
    /**
     * Sets the display name of the net.skret.item.
     ...
     *
     * @param name The desired display name of the net.skret.item stack.
     * @return The {@link ItemBuilder} instance.
     */
    ...
    /**
     * Returns either the display name of the net.skret.item, if it exists, or null if it doesn't.
     *
     ...
     *
     * @return The net.skret.item's display name as returned from its {@link ItemMeta}.
     */
    ...
    /**
     * Sets the lore of the net.skret.item. This method is a var-args alias for the
     * {@link #lore(List)} method.
     *
     * @param lore The desired lore of the net.skret.item, with each line as a separate string.
     * @return The {@link ItemBuilder} instance.
     */
    ...
    /**
     * Sets the lore of the net.skret.item.
     ...
     * some consideration into how the net.skret.item will be rendered with the lore.
     *
     * @param lore The desired lore of the net.skret.item, with each line as a separate string.
     * @return The {@link ItemBuilder} instance.
     */
    ...
    /**
     * Gets the lore of the net.skret.item as a list of strings. Each string represents a line of the
     * net.skret.item's lore in-game.
     *
     ...
     *
     * @return The lore of the net.skret.item.
     */
     ...
     * the net.skret.item's color, however it will obviously be nonsensical.
     *
     * @param color The desired color of the net.skret.item.
     * @return The {@link ItemBuilder} instance.
     */
     ...
     *
     * @param data The desired data-value (durability) of the net.skret.item.
     * @return The {@link ItemBuilder} instance.
     */
    ...
    /**
     * Sets the durability (data value) of the net.skret.item.
     *
     * @param durability The desired durability of the net.skret.item.
    ...
    /**
     * Returns the durability or data value of the net.skret.item.
     *
     * @return The durability of the net.skret.item.
     */
     ...
     *
     * @return The appropriate {@link ItemDataColor} of the net.skret.item or null.
     */
     ...
     *
     * @param enchantment The enchantment to apply to the net.skret.item.
     * @param level The level of the enchantment to apply to the net.skret.item.
     * @return The {@link ItemBuilder} instance.
     */
     ...
     *
     * @param enchantment The enchantment to remove from the net.skret.item.
     * @return The {@link ItemBuilder} instance.
     */
    ...
    /**
     * If the net.skret.item has {@link SkullMeta} (i.e. if the net.skret.item is a skull), this can
     ...
     *
     * @param name The name of the player the skull net.skret.item should resemble.
     * @return The {@link ItemBuilder} instance.
     */
